package dev.lyze.clipper2.offset;

import static dev.lyze.clipper2.core.InternalClipper.DEFAULT_ARC_TOLERANCE;
...
import dev.lyze.clipper2.tangible.OutObject;
import dev.lyze.clipper2.tangible.RefObject;
